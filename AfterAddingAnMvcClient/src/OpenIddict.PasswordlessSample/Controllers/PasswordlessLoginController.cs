...
using OpenIddict.PasswordlessSample.ViewModels.PasswordlessLogin;
...
namespace OpenIddict.PasswordlessSample.Controllers;
[AllowAnonymous]
public class PasswordlessLoginController : Controller
{
    ...
    public async Task<ActionResult> StartLogin() => View();
